...
func WithBatchSize[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
	batchSize int,
...
func WithConverter[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
	c converter.Converter[Entity, DTO, ID],
) Option[Entity, DTO, ID] {
	return func(s *Store[Entity, DTO, ID]) {
		s.Converter = c
	}
...
func WithTable[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
	table string,
) Option[Entity, DTO, ID] {
	return func(s *Store[Entity, DTO, ID]) {
		s.Table = table
...
func WithQueryBuilderOption[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
...
func WithDialect[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
	d sqlxquery.Dialect,
) Option[Entity, DTO, ID] {
	return func(s *Store[Entity, DTO, ID]) {
		s.Dialect = d
...
func WithPKColumn[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
	col string,
) Option[Entity, DTO, ID] {
	return func(s *Store[Entity, DTO, ID]) {
		s.PKColumn = col
...
func WithReturningID[Entity store.Entity[ID], DTO store.Entity[ID], ID comparable](
	v bool,
) Option[Entity, DTO, ID] {
	return func(s *Store[Entity, DTO, ID]) {
		s.ReturningID = v
